...
export const BENCHMARKS: Benchmark[] = [
  ...
  { key: "niftylargemid250", label: "Nifty LargeMidcap 250 (index fund proxy)", yahooSymbol: "NIFTY_LARGEMID250.NS", proxySchemeCode: 152156, categoryHint: ["large & mid", "large and mid"] },
